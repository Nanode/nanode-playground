...
// debug status codes returned by updatePachube()
	...
	public function debugStatusCode ( $status_code ){
		...
		switch ($status_code){			
			...
			case 401:
				$msg = "Pachube API key was incorrect. Have you changed the api_key variable on line 8 in submit_pachube.php ?";
				break;

			case 404:
				$msg = "Feed ID does not exist. Have you changed the feed_id variable on line 8 in submit_pachube.php ?";
				break;
